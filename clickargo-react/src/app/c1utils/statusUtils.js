...
export function getStatusDesc(status, extra, recovery) {
    let statusRecovery;
    switch (status) {
    ...
    return (<div>{statusRecovery} <small>
        {recovery && (
            /*CPEDI-204 PORTEDI-1948[Recovery Function] Request change recovery icon*/
