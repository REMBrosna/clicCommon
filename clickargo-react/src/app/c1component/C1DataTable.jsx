                                ...
                                if (isShowToolbar) {
                                    ...
                                    if (showManualAdd) {
                                        if (showManualAdd.type === "popUp") {
                                            elTemplate.push(<Tooltip title={"Manually Add"} aria-label="add" key="Add">
                                                <Button onClick={showManualAdd.popUpHandler}><PublishIcon viewBox="0 0 24 24" color="primary" /></Button>
                                            </Tooltip>);
                                        } else {
                                            elTemplate.push(<Link to={showManualAdd.path} key="AddPath">
                                                <Tooltip title={"Manually Add"} aria-label="add">
                                                    <Button><PublishIcon viewBox="0 0 24 24" color="primary" /></Button>
                                                </Tooltip></Link>);
                                        }
                                    }
