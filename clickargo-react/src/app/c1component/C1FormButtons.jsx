...
const C1FormButtons = ({ options, children }) => {
    ...
    if (options.delete && options.delete.show) {
        elDelete = <Tooltip title={t("buttons:delete")}>
            {/* <IconButton aria-label="save" color="primary" type="button" onClick={options.save.eventHandler}> */}
            <IconButton aria-label="save" color="primary" type="button" onClick={options.delete.eventHandler}>
    ...
    let elSubmit = null;
    if (options.submit) {
        elSubmit = <Tooltip title={t("buttons:submit")}>
    ...
    if (options.confirm && options.confirm.show) {
        elConfirm = <Tooltip title={"Confirm"}>
            <IconButton aria-label="pay" color="primary" type="button" onClick={options.confirm.eventHandler}>
                <CheckCircleIcon />
            </IconButton>
        </Tooltip>;
    }
    ...
    if (options.pay && options.pay.show) {
        elPay = <Tooltip title={"Pay"}>
            <IconButton aria-label="confirm" color="primary" type="button" onClick={options.confirm.eventHandler}>
                <PaymentIcon />
            </IconButton>
        </Tooltip>;
    }
