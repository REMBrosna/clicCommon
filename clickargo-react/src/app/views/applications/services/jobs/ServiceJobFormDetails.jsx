...
const ServiceJobFormDetails = () => {
    ...
    const handleExitOnClick = () => {
        history.push("/applications/jobs/list");
    }
    ...
    return loading ? <MatxLoading /> : (<React.Fragment>
        <C1FormDetailsPanel
            breadcrumbs={[
                { name: "Jobs List", path: "/applications/jobs/list" },
                { name: "Job Details" }
            ]}
            title={bcLabel}
                ...
                <Grid container spacing={3}>
                    <Grid item xs={12}>
                        <Paper>
                            ...
                            {tabIndex === 0 && <JobDetails viewType={viewType}
                            ...
                            {tabIndex === 1 && <JobAuthorisationLetters viewType={viewType}
                                inputData={inputData} />}
...
export default withErrorHandler(ServiceJobFormDetails);