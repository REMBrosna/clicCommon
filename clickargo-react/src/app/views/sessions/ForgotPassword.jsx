...
const ForgotPassword = () => {
    ...
    const handleFormSubmit = async (event) => {
        setLoading(true);
        try {
            const { data } = await axios.post("/api/v1/clickargo/manageusr/forgotpwd", state);
            if (data) {
                            ...
                            <ValidatorForm onSubmit={handleFormSubmit} noValidate>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <Link to="/session/signin">
                                        <Button className="capitalize" variant="contained" color="secondary">{t("session:resetPwd.signIn")}</Button>
                                    </Link>
                                </div>
                            </ValidatorForm>
                        </div>
