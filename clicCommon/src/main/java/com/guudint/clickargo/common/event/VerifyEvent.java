...
public class VerifyEvent<E, D extends AbstractDTO<D, E>> extends AbstractWorkflowStateChangeEvent<E, D> {
	...
	public VerifyEvent(Object source, WorkflowTypeEnum wfType, D dto) {
		super(source);
		this.wfType = wfType;
		this.dto = dto;
	}
