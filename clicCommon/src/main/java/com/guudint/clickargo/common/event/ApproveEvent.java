...
public class ApproveEvent<E, D extends AbstractDTO<D, E>> extends AbstractWorkflowStateChangeEvent<E, D> {
	...
	public ApproveEvent(Object source, WorkflowTypeEnum wfType, D dto) {
		super(source);
		this.wfType = wfType;
		this.dto = dto;
	}
