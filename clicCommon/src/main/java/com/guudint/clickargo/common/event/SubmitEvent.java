...
public class SubmitEvent<E, D extends AbstractDTO<D, E>> extends AbstractWorkflowStateChangeEvent<E, D> {
	...
	public SubmitEvent(Object source, WorkflowTypeEnum wfType, D dto) {
		super(source);
		this.wfType = wfType;
		this.dto = dto;
	}
