...
public class AccnSusPostListenerService extends AbstractWfPostEventListenerService<TCoreAccn, CoreAccn> {

	private static Logger LOG = Logger.getLogger(AccnSusPostListenerService.class);
	...
	public void processSubmit(CoreAccn dto, Principal principal) throws Exception {
		...
		param.setTemplateId(ClickargoNotifTemplates.ACCN_SUS_SUB.getId());
	...
	public void processApprove(CoreAccn dto, Principal principal) throws Exception {
		...
		NotificationParam param = new NotificationParam();
		param.setAppsCode(ServiceTypes.CLICTRUCK.getAppsCode());
		param.setTemplateId(ClickargoNotifTemplates.ACCN_SUS_APP.getId());
	...
	public void processReject(CoreAccn dto, Principal principal) throws Exception {
		...
		NotificationParam param = new NotificationParam();
		param.setAppsCode(ServiceTypes.CLICTRUCK.getAppsCode());
		param.setTemplateId(ClickargoNotifTemplates.ACCN_SUS_REJ.getId());
