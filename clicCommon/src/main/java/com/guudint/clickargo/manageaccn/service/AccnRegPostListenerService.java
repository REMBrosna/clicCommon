...
public class AccnRegPostListenerService extends AbstractWfPostEventListenerService<TCoreAccn, CoreAccn> {

	private static Logger LOG = Logger.getLogger(AccnRegPostListenerService.class);
	...
	// Note: Refer to ClickargoNotifTemplates for notification templates
	@Override
	public void processSubmit(CoreAccn dto, Principal principal) throws Exception {
		...
		param.setTemplateId(ClickargoNotifTemplates.ACCN_REG_SUB.getId());
	...
	public void processApprove(CoreAccn dto, Principal principal) throws Exception {
		...
		NotificationParam param = new NotificationParam();
		param.setAppsCode(ServiceTypes.CLICTRUCK.getAppsCode());
		param.setTemplateId(ClickargoNotifTemplates.ACCN_REG_APP.getId());
	...
	public void processReject(CoreAccn dto, Principal principal) throws Exception {
		...
		NotificationParam param = new NotificationParam();
		param.setAppsCode(ServiceTypes.CLICTRUCK.getAppsCode());
		param.setTemplateId(ClickargoNotifTemplates.ACCN_REG_REJ.getId());
