...
/**
 * TCkMstInvoiceType generated by hbm2java
 */
@Entity
@Table(name = "T_CK_MST_INVOICE_TYPE")
public class TCkMstInvoiceType extends COAbstractEntity<TCkMstInvoiceType> {
	 ...
	 * @param invtName
	 */
	public TCkMstInvoiceType(String invtId, String invtName) {
		this.invtId = invtId;
		this.invtName = invtName;
	}

	public TCkMstInvoiceType(String invtId, String invtName, String invtDesc, String invtDescOth, Character invtStatus,
	 ...
	 */
	@Override
	public int compareTo(TCkMstInvoiceType o) {
