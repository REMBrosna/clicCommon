...
/**
 * TCkMstPaymentType generated by hbm2java
 */
@Entity
@Table(name = "T_CK_MST_PAYMENT_TYPE")
public class TCkMstPaymentType extends COAbstractEntity<TCkMstPaymentType> {
	...
	// Constructors
	////////////////
	public TCkMstPaymentType() {
	}

	public TCkMstPaymentType(String ptyId) {
		this.ptyId = ptyId;
	}
	 ...
	 * @param pytName
	 */
	public TCkMstPaymentType(String ptyId, String pytName) {
		this.ptyId = ptyId;
	 ...
	 * @param pytUidLupd
	 */
	public TCkMstPaymentType(String ptyId, String pytName, String pytDesc, String pytDescOth, Character pytStatus,
	 ...
	 *      
	 */
	public int compareTo(TCkMstPaymentType o) {
	...
	/////////////
	@Id
	@Column(name = "PTY_ID", unique = true, nullable = false, length = 35)
