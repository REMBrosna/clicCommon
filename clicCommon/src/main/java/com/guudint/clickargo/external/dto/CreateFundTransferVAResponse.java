...
public class CreateFundTransferVAResponse extends BaseResponse {
    ...
    public CreateFundTransferVAResponse() {

	}
	
	public CreateFundTransferVAResponse(String status) {
		this.status = status;
	}

	public CreateFundTransferVAResponse(String status, ErrorData err) {
		super(status, err);
