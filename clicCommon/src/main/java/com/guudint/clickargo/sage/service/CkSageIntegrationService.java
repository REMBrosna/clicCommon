...
@Service
public class CkSageIntegrationService {

	private static Logger LOG = Logger.getLogger(CkSageIntegrationService.class);
	...
	public void sendEmailToSageConsult(TCkSageIntegration sageIntegration) throws Exception {
		...
		String bDate = CkSageExportExcelService.yyyyMMddSDF.format(sageIntegration.getSintDtStart());
		String eDate = CkSageExportExcelService.yyyyMMddSDF.format(sageIntegration.getSintDtEnd());
		...
		try {
			...
			param.setTemplateId("CKT_NTL_0000"); // empty template id
