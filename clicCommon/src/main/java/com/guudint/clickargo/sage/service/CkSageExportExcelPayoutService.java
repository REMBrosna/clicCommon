...
@Service
public class CkSageExportExcelPayoutService extends CkSageExportExcelService {

	// Static Attributes
	////////////////////
	private static Logger log = Logger.getLogger(CkSageExportExcelPayoutService.class);
