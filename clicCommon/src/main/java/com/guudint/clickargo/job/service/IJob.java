 ...
 *
 */
public interface IJob<ID, E, D extends AbstractDTO<D, E>> {

	/**
	 * Create a template for the new job
	 * 
	 * @param principal
	 * @return
	 ...
	 * @throws Exception
	 */
	public EntityFilterResponse filterJobs(Map<String, String> params, Principal principal)
			throws ParameterException, EntityNotFoundException, ValidationException, ProcessingException, Exception;
