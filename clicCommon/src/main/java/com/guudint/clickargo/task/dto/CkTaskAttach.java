...
public class CkTaskAttach extends AbstractDTO<CkTaskAttach, TCkTaskAttach> {
	...
	@Size(groups = { CreateValid.class, UpdateValid.class,
			SubmitValid.class }, max = 35, message = "{valid.task.attId.maxLength}")
	private String attId;
	private CkTask TCkTask;
	private MstAttType TMstAttType;
	@Size(groups = { CreateValid.class, UpdateValid.class,
			SubmitValid.class }, max = 256, message = "{valid.task.attName.maxLength}")
	private String attName;
	@Size(groups = { CreateValid.class, UpdateValid.class,
			SubmitValid.class }, max = 1024, message = "{valid.task.attLoc.maxLength}")
	 ...
	 * @param entity
	 */
	public CkTaskAttach(TCkTaskAttach entity) {
		super(entity);
	}
	 ...
	 * @param TMstAttType
	 */
	public CkTaskAttach(String attId, CkTask TCkTask, MstAttType TMstAttType) {
		this.attId = attId;
	 ...
	 * @param attUidLupd
	 */
	public CkTaskAttach(String attId, CkTask TCkTask, MstAttType TMstAttType, String attName, String attLoc,
	 ...
	 */
	@Override
	public int compareTo(CkTaskAttach o) {
	 ...
	 * @return the tCkTask
	 */
	public CkTask getTCkTask() {
		return TCkTask;
	}

	/**
	 * @param tCkTask the tCkTask to set
	 */
	public void setTCkTask(CkTask tCkTask) {
		TCkTask = tCkTask;
	}
