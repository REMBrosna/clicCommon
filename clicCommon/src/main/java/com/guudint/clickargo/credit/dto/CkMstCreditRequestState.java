...
public class CkMstCreditRequestState extends AbstractDTO<CkMstCreditRequestState, TCkMstCreditRequestState> {

	private static final long serialVersionUID = 9073998080848732334L;
	private String stId;
	...
	public CkMstCreditRequestState() {
	}

	public CkMstCreditRequestState(TCkMstCreditRequestState entity) {
		super(entity);
	}

	public CkMstCreditRequestState(String stId, String stName) {
		this.stId = stId;
		this.stName = stName;
	}

	public CkMstCreditRequestState(String stId, String stName, String stDesc, String stDescOth, Character stStatus,
	...
	@Override
	public int compareTo(CkMstCreditRequestState o) {
